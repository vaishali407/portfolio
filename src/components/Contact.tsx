...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-44 md:py-52 lg:py-60 px-6 md:px-12 bg-[#080808] bg-grain border-t border-white/10 relative">
      <div className="max-w-[1600px] mx-auto space-y-20">
        {/* MAIN SECTION HEADING - Large Chapter Title with Scroll Reveal */}
        <SectionHeader number="06" title="CONTACT" sectionId="contact" className="mb-12" />
